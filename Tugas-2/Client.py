...
try:
    ...
    print("Could not connect to the server. Ensure it is running and accessible.")
    exit()
...
def send(msg):
    try:
        ...
        print("Connection broken. Could not send message.")
...
while x.lower() != 'quit':
    key = "gadogado"
    x = input("Enter message (or 'quit' to exit): ")
